...
- Think Stats-inspired extension implementations for EDA, distributions, CDFs, model fitting, density estimation, resampling, hypothesis testing, regression, and survival analysis
- Think Bayes-inspired extension implementations for PMFs, likelihood updates, Bayes factors, grid approximation, conjugate models, posterior prediction, joint distributions, mixtures, decision analysis, and mark-and-recapture
